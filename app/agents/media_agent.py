...
STYLE_MAP = {
    "cinematic": "ONLY show the main characters described — NO extra people, NO crowds, NO bystanders, NO background figures unless explicitly requested. Focus tightly on the main subjects. Photorealistic photograph of REAL HUMANS with normal human ears and features, shot on 35mm film with RICH DETAIL: visible skin texture, fabric weave, environmental details like dust particles in light beams, scratches on surfaces, realistic imperfections. Natural muted color palette with occasional warm lamplight accents. Shallow depth of field with cinematic bokeh, slight film grain. Looks like a still frame from an A24 independent drama film. Realistic imperfect lighting — mixed daylight from windows and warm incandescent bulbs. Natural skin textures with pores and subtle blemishes, no airbrushing. Grounded, documentary-style realism. NO fantasy elements, NO elf ears, NO pointed ears, NO supernatural features — strictly realistic humans only.",
